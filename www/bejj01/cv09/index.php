...
<main class="container">
    ...
    <div class="row labels">
        ...
        <a class="new-button text-left btn btn-primary" href="create.php?offset=<?php echo $offset; ?>"><i class="fas fa-plus"></i> Add new mango</a>
    </div>
            ...
            <div class="col-lg-4 col-md-5 mb-4">
                <div class="card text-muted">
                    ...
                    <div class="card-footer">
                        <a class="btn btn-dark" href="buy.php?id=<?php echo $good['id']; ?>&offset=<?php echo $offset ?>">Buy</a>
