        ...
        <form method="POST">
            ...
            <div class="form-group">
                ...
                <input class="form-control" id="name" name="name"
                       value="<?php if (!empty($client)) echo $client['name'] ?>"/>
                <label for="name">Surname</label>
                <input class="form-control" id="surname" name="surname"
                       value="<?php if (!empty($client)) echo $client['surname'] ?>"/>
                <label for="name">Phone</label>
                <input class="form-control" id="phone" name="phone"
                       value="<?php if (!empty($client)) echo $client['phone'] ?>"/>
                <label for="name">ICO</label>
                <input class="form-control" id="ico" name="ico"
                       value="<?php if (!empty($client)) echo $client['ico'] ?>"/>
            </div>
        ...
        <form method="POST">
            ...
            <div class="form-group">
                ...
                <input class="form-control" id="password" name="password"
                       value="Password should be at least 5 characters"/>
