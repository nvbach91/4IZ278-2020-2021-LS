...
<main class="container">
    ...
    <ul>
        ...
        <li>
            <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Coworking Smetana.</p>
        </li>
        <li>
        ...
        <li>
            <p><strong>Website</strong> refers to Coworking Smetana, accessible from <a href="https://eso.vse.cz/%7Ekadm08/sp/" rel="external nofollow noopener" target="_blank">https://eso.vse.cz/~kadm08/sp/index.php</a></p>
        </li>
        <li>
    ...
    <ul>
        <li>By email: coworkingsmetana@gmail.com</li>
    </ul>
    </main>
