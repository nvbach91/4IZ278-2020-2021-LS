<?php require __DIR__ . '/../database/SlideDB.php'; ?>
<?php
$slideDB = new SlideDB();
$slides = $slideDB->fetchAll();
?>
    ...
    <div class="carousel-inner" role="listbox">
        <?php foreach($slides as $index=>$slide): ?>
            <div class="carousel-item slide <?php echo $index == 0 ? 'active' : ''; ?>">
                <img class="d-block img-fluid slide-image" src="<?php echo $slide['image']; ?>" alt="<?php echo $slide['title']; ?>">
            </div>
        <?php endforeach; ?>
    </div>
