    ...
    <div class="col-lg-9">
        <div class="row">
            <div class="col-md-8 order-md-1">
                ...
                <div class="row">
                    <form  action="{{ route('admin_liquor.update', ['liquor' => $liquor->id])}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col mb-3">
                                ...
                                <input type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}"
                                       name="name" id="name"
                                       value="{{ (old('name')) ? old('name') : $liquor->name }}"
                                       required="">
                                @if ($errors->has('name'))
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                ...
                                <input type="file" name="image" value="{{ (old('image')) ? old('image') : $liquor->image }}" class="form-control{{ $errors->has('image') ? ' is-invalid' : '' }}" id="image">
                                @if ($errors->has('image'))
                                    <div class="text-danger">
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                ...
                                <input type="text"
                                       ...
                                       value="{{ (old('category')) ? old('category') : $liquor->category }}"
                                       required="">
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                ...
                                <input type="text" class="form-control{{ $errors->has('volume') ? ' is-invalid' : '' }}"
                                       ...
                                       value="{{ (old('volume')) ? old('volume') : $liquor->volume }}"
                                       required="">
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                ...
                                <input type="text"
                                       ...
                                       value="{{ (old('alcohol_percentage')) ? old('alcohol_percentage') : $liquor->alcohol_percentage }}"
                                       required="">
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                ...
                                <input type="text" class="form-control{{ $errors->has('price') ? ' is-invalid' : '' }}"
                                       name="price" id="price"
                                       value="{{ (old('price')) ? old('price') : $liquor->price }}"
                                       required="">
                                @if ($errors->has('price'))
                                    <div class="text-danger">
