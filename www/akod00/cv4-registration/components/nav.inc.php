...
<header>
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <a class="navbar-brand" href="/~akod00/cv04">
        ...
        <div class="collapse navbar-collapse" id="navbarColor01">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item<?php echo activeMenu('Home') ?>">
                    <a class="nav-link" href="/~akod00/cv04">Home</a>
                </li>
                <li class="nav-item<?php echo activeMenu('Users') ?>">
                    <a class="nav-link" href="/~akod00/cv04/pages/admin/users.php">Users</a>
                </li>
                <li class="nav-item<?php echo activeMenu('About') ?>">
                    <a class="nav-link" href="/~akod00/cv04/pages/about.php">About</a>
                </li>
            </ul>
          <?php
