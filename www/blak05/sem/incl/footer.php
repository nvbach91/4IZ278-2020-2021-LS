...
<footer class="pt-4 my-md-5 pt-md-5 border-top">
    <div class="row">
      <div class="col-12 col-md">
        <img class="mb-2" src="img/logo.png" alt="" width="100" height="72">
      ...
      <div class="col-6 col-md">
        <h5>Pivotéka Modřany</h5>
        <p class="text-small text-secondary">
          E-shop založený třemi přáteli v garáži. Vše začlo pivními recenzemi. Komentáře pod nimi nás dovedli k úvaze, proč nezaložit pivní e-shop s našim vlastním výběrem piv. 
        </p>
      </div>
    </div>
  </footer>
