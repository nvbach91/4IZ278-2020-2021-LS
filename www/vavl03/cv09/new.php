...
if ('POST' == $_SERVER['REQUEST_METHOD']) {
    $stmt = $db->prepare('INSERT INTO goods(name, description, price, img) VALUES (?, ?, ?, ?)');
    $stmt->execute([$_POST['name'], $_POST['description'], (float) $_POST['price'], $_POST['img']]);
...
<main class="container">
    ...
    <form class="form-signin" method="POST">
        ...
        <div class="form-label-group">
            ...
            <input name="img" class="form-control" placeholder="Img" required>
        </div>
        <br>
