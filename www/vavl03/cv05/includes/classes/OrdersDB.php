...
class OrdersDB extends Database
{
    ...
    public function fetch($args)
    {
        ...
        if (isset($order)) {
            ...
            echo "Number: ", $order[0], " Total: ", $order[1], PHP_EOL;
        } else {
    ...
    public function create($args)
    {
        ...
        array_push($orders, array($args['number'], $args['total']));
        $this->writeDatabase($orders);
        echo "Order number ", $args['number'], ", price ", $args['total'], " was created", PHP_EOL;
    }
