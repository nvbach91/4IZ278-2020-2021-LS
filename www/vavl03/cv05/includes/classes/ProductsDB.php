...
class ProductsDB extends Database
{
    ...
    public function fetch($args)
    {
        ...
        if (isset($product)) {
            ...
            echo "Name: ", $product[0], " Price: ", $product[1], PHP_EOL;
        } else {
    ...
    public function create($args)
    {
        ...
        array_push($products, array($args['name'], $args['price']));
        $this->writeDatabase($products);
        echo "Product ", $args['name'], " with price ", $args['price'], " was created", PHP_EOL;
    }
