...
<main class="container-sm">
    ...
    <form class="row g-3 form-registration" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
        <div class="col-md-12">
            ...
            <input name="name" type="text" class="form-control" id="inputNameRegister" value ="<?php echo isset($name) ? $name : '' ?>" placeholder="John Smith">
        </div>
        <div class="col-md-12">
            <label for="inputEmailRegister" class="form-label">Email</label>
            <input name="email" type="email" class="form-control" id="inputEmailRegister" value ="<?php echo isset($email) ? $email : '' ?>" placeholder="email@example.com">
        </div>
        <div class="col-md-12">
        ...
        <div class="col-md-12">
            ...
            <input name="confirmPassword" type="password" class="form-control" id="inputPasswordRegisterConfirm">
        </div>
