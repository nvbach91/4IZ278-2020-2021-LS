...
if ($isSubmitted) {
    ...
    if (empty($invalidInputs)) {
        ...
        $usersDB->addItem([$username, $email, $hashedPassword, $address, $firstName, $lastName,1]);
        session_start();
...
<html>
  ...
  <body style="height: 100%;
    ...
    <h2>Thank you for registering at <a href="http://eso.vse.cz/~lamj00/e-shop">Componetoro</a>.</h2>
  </body>
</html>
';
        sendMail($address,"Thank you for registering at Componentoro ".$firstName,$body);
...
<main class="cont">
    ...
    <form class="form-login row g-3" method="POST" action="">
        ...
        <div class="col-md-6">
            ...
            <input type="text" class="form-control" name="lastName" placeholder="Otto"
        ...
        <a style="align-self: center" href="<?php echo $google_client->createAuthUrl()?>"><img src="img/google.png"  alt="Log in with google account"/></a>
        <?php endif;?>
